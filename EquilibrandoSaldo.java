...
public class EquilibrandoSaldo {
    public static void main(String[] args) {
        ...
        //System.out.println("Favor informar o valor do déposito")
        double valorDeposito = scanner.nextDouble();
        //System.out.println("Favor informar o valor que deseja retirar")
        double valorRetirada = scanner.nextDouble();

        double saldo = (saldoAtual+valorDeposito)- valorRetirada;
        
        System.out.printf("Saldo atualizado na conta: %.1f",saldo);
